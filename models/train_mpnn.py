...
# model
model = MPNNModel()
optimizer = tf.keras.optimizers.Adam(learning_rate='your params'.learning_rate)
...
df_test.to_csv('save csv to check')
...
test_pf.to_csv('save csv to check')
